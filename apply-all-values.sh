...
helm upgrade theia-cloud-base theia-cloud-repo/theia-cloud-base --install --namespace $namespace -f theia-base-helm-values.yml

helm upgrade theia-cloud-crds theia-cloud-repo/theia-cloud-crds --install --namespace $namespace -f theia-crds-helm-values.yml
